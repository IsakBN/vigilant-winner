...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    console.log('[LOGIN] signIn success, redirecting to /dashboard')
  ...
  async function handleGitHubLogin() {
    ...
    if (signInError) {
      setError(signInError.message ?? 'Failed to sign in with GitHub. Please try again.')
      setLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-2">Sign in to your BundleNudge account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link href="/forgot-password" className="text-sm text-bright-accent hover:underline">
                  Forgot password?
                </Link>
              </div>
