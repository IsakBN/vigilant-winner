 ...
 * Integration Icons
 *
 * SVG icons for third-party integration services.
 */
...
export function BugsnagIcon() {
    return (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="none" />
            <circle cx="8" cy="10" r="2" fill="currentColor" />
            <circle cx="16" cy="10" r="2" fill="currentColor" />
            <path d="M8 15c1.5 2 5.5 2 8 0" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" />
        </svg>
    )
}

export function CrashlyticsIcon() {
    return (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
