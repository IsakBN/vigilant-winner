            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm bg-warm-green/20 text-green-700 px-3 py-1 rounded-full font-medium">Active</span>
                </div>

                {/* Stage indicators */}
                <div className="flex items-center gap-2">
                  <div className="flex-1 h-3 bg-warm-green rounded-full" />
                  <div className="flex-1 h-3 bg-warm-green rounded-full" />
                  <div className="flex-1 h-3 bg-warm-green/50 rounded-full animate-pulse" />
                ...
                <div className="flex justify-between text-sm text-text-light">
                  <span>1%</span>
                  <span>10%</span>
                  <span className="text-warm-green font-bold">25%</span>
                  <span>100%</span>
                </div>
              </div>
              ...
              <div className="bg-pastel-blue/10 rounded-xl p-4 space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="bg-white px-3 py-1.5 rounded-lg text-sm border border-soft-yellow/30 flex items-center gap-2">
                    <PercentIcon className="w-4 h-4 text-amber-500" />
                    25% of users
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 text-center border border-gray-100">
                  <div className="text-2xl font-bold text-warm-green">0</div>
              ...
              <div className="flex gap-3">
                ...
                <button className="px-4 py-3 border-2 border-red-200 text-red-600 rounded-xl font-bold hover:bg-red-50 transition-all">
                  Pause
                </button>
              </div>
            </div>
