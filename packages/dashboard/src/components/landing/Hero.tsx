import { CheckIcon, CheckBoldIcon, CloudDownloadIcon } from '@/components/icons'
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        <div className="flex flex-col gap-6 lg:order-1">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/login" className="bg-bright-accent text-white text-lg font-bold px-10 py-5 rounded-xl shadow-md hover:shadow-lg hover:shadow-bright-accent/20 transition-all flex items-center gap-2">
              Get Started Free
            </Link>
