  ...
  const metrics = [
    {
      ...
      subtext: `${otaMetrics?.successRate?.toFixed(1) ?? 0}% success`,
      icon: Download,
    ...
    },
    {
      ...
      subtext: `${buildQueue?.completedToday ?? 0} completed today`,
      icon: Hammer,
    ...
    },
    {
      ...
      subtext: `${getAvgLatency(apiHealth)}ms avg`,
      icon: Activity,
    ...
    },
    {
      ...
      subtext: `${storage?.totalBundles ?? 0} bundles`,
      icon: HardDrive,
    ...
    },
    {
      ...
      subtext: `${stats?.apps.total ?? 0} total`,
      icon: AppWindow,
      color: 'text-pastel-blue',
    },
    {
      ...
      subtext: `${getPremiumCount(stats)} premium`,
      icon: Users,
      color: 'text-pastel-green',
    },
  ]
