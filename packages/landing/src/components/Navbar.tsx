    ...
    <header className="sticky top-0 z-50 bg-cream-bg/80 backdrop-blur-md border-b border-soft-yellow/50">
      <div className="container-fluid h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="https://app.bundlenudge.com/login" className="bg-bright-accent text-white text-base font-bold px-6 py-2 rounded-lg shadow-lg hover:shadow-bright-accent/30 transition-all">
            Get Started
          </a>
        </nav>
      </div>
