...
/**
 * SubscriptionsPagination Component
 *
 * Pagination controls for subscription list with:
 * - Page info display
...
export interface SubscriptionsPaginationProps {
    page: number
    totalPages: number
    total: number
    limit: number
    ...
    return (
        <div className="flex items-center justify-between px-4 py-3 bg-card rounded-xl border border-border">
            <div className="text-sm text-text-light">
                Showing {String(start)} to {String(end)} of {String(total)} subscriptions
            </div>
