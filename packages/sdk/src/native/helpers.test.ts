...
const mockModule = {
  getConfiguration: vi.fn(), getCurrentBundleInfo: vi.fn(), getBundlePath: vi.fn(),
  notifyAppReady: vi.fn(), restartApp: vi.fn(), clearUpdates: vi.fn(), saveBundleToStorage: vi.fn(),
}
...
describe('native/helpers', () => {
  beforeEach(() => { vi.clearAllMocks(); mockIsNative = false })
